    ...
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="actionbutton">
                ...
                <a class='btn btn-info float-right' href="{{ asset('subject') }}">List</a>
            ...
            <form action="{{ route('subject.update', [$subject->id]) }}" method="post">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="description">Name <span
                            class="required">*</span></label>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="name" class="form-control col-md-12 col-xs-12" name="name"
                            placeholder="Enter subject name" required="required" type="text"
